...
window.CONTENT = {
  ...
  "statement_tagline": "My work applies the instruments of architecture to the human body.",
  "statement": [
    "Height fields, isometric projection, voxel decomposition, point clouds, the surveyor’s annotation: the conventions by which we describe buildings and terrain, turned toward a face. What returns is a body read as site.",
  ...
  "about_tagline": "The digital carries no weight until it is pressed into cotton rag.",
  "about": [
    "Every result lands in something physical and slow. Cyanotype, the chemistry of the blueprint, receives geometry that was never photographed. A pen plotter lays white ink onto mat board one stroke at a time.",
  ...
  "process_tagline": "Written in code. Drawn by machine.",
  "process": [
    "Geometry is generated in Rhino and Grasshopper, then handed to a plotter that lays white ink one stroke at a time. This clip follows Duality from the digital model to the plotter bed: two heads, 1,904 nodes."
  ],
